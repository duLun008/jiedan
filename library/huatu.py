...
LastEditors: dulun
LastEditTime: 2023-07-19 11:03:05
'''
import pandas as pd
...
labels = ["日本文学", "经济学入门", "管理与领导", "市场营销", "金融学", "创业与创新", "战略规划", "心理学", "历史与文化", "自我提升"]
np.array(years, dtype=int)
for key,l in zip(student_points,labels):
    plt.plot(years, student_points[key], marker='o', label=l)


plt.title(f"学生书籍前十类趋势图 (2014-2017)")
plt.xlabel("Year")
plt.ylabel("Count")
plt.xticks(years)
